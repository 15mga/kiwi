...
type IPacker interface {
	...
	PackResponseOk(tid int64, pkt []byte) ([]byte, *util.Err)
	UnpackResponseOk(bytes []byte) (tid int64, payload []byte, err *util.Err)
	PackResponseFail(tid int64, code uint16) ([]byte, *util.Err)
	UnpackResponseFail(bytes []byte) (tid int64, code uint16, readErr *util.Err)
