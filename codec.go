...
type ICodec interface {
	...
	JsonUnmarshal2(svc TSvc, code TCode, data []byte) (util.IMsg, *util.Err)
	Spawn(svc TSvc, code TCode) (util.IMsg, *util.Err)
	SpawnRes(svc TSvc, code TCode) (util.IMsg, *util.Err)
	BindFac(svc TSvc, code TCode, fac util.ToMsg)
